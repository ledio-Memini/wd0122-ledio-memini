...
const annoInCuiViviamo = prompt('inserisci anno solare')

let etaUtente = annoInCuiViviamo - annoDiNascita
let testo = ' eta utente' 
document.write(etaUtente,testo) 


if (etaUtente >= 18){
    document.write('<br> sei maggiorenne')
    console.log(' sei maggiorenne')
}else{
    document.write('<br> sei minorenne')
