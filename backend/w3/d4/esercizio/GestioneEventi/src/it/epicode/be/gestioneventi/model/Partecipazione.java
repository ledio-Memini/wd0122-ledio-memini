...
@Entity
@NamedQuery(name = "partecipazioniDaConfermarePerEvento", query = "SELECT p FROM Partecipazione p WHERE p.stato = it.epicode.be.gestioneventi.model.StatoPartecipazione.DA_CONFERMARE AND p.evento = :evento")
